  ...
  return <>
    <main>
      <section className="hero"><div className="container hero-grid">
        <div className="reveal"><span className="hero-mark-spin" aria-hidden="true"><img src={mark} alt="" /></span><span className="eyebrow">Responsible AI advisory · Ghana</span><h1 className="display">AI that moves with <em>confidence.</em></h1><p className="hero-lead">Your Partner in <TypingTagline words={["Responsible AI Adoption", "AI Governance", "AI Policies", "AI Transformation", "AI Risk & Ethics"]} /></p><p className="hero-copy">Helping organizations understand, govern, transform and scale AI for meaningful business impact.</p><div className="actions"><ButtonLink href="/contact" testId="button-hero-consultation">Book a Consultation</ButtonLink><ButtonLink href="/services" secondary testId="button-hero-services">Explore Our Services</ButtonLink></div><div className="hero-note"><span /> Built for boards, teams and the work between them</div></div>
        <AbstractVisual />
      </div></section>
